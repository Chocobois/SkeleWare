...
const dialogue: { [key: string]: [string, string][] } = {
	...
	"3_loot": [
		[red, "What a haul!"],
		[yellow, "It's all covered in dirt."],
		[red, "Dirt is good. It cures diseases."],
		[yellow, "Let's brush it off instead."],
	],
	"4_shoes": [
	...
	"5_package": [
		[red, "That was quick!"],
		[yellow, "It's only been a few minutes."],
		[blue, "Bah. They're all wrinkled."],
		[red, "... I got just what we need."],
	],
	"6_baseball": [
